...
elementos_G = ["chocolate", "música", "cine", "viajar", "leer"]
print(elementos_G[-2])  # Penúltimo elemento
...
# palabras “loro” y “oso”, respectivamente. Imprimir la lista resultante por pantalla. ¡Puedes hacerlo 
# como se muestra en los videos o bien investigar cómo funciona el indexing con números negativos! 
# animales = ["perro", "gato", "conejo", "pez"]

animales = ["perro", "gato", "conejo", "pez"]
animales[1] = "loro"         # Segundo elemento
animales[-1] = "oso"         # Último elemento usando índice negativo
print(animales)

# 5) Analizar el siguiente programa y explicar con tus palabras qué es lo que realiza.
# números = [8, 15, 3, 22, 7]
# números.remove(max(numeros))
# print(numeros)

números = [8, 15, 3, 22, 7]
números.remove(max(números))  # Elimina el número más grande (22)
print(números)
